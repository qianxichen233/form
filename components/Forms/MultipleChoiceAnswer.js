...
const RenderBoxCheckBox = (checked) => {
    if (checked)
        return (
            <BoxCheckBoxFill className={classes.icon} size={20} color="grey" />
        );
...
const updateAnswer = (answer, index, type) => {
    ...
    } else answer[index] = !answer[index];
    return answer;
};
                        ...
                        <div
                            ...
                            onClick={
                                props.display
                                    ...
                                    : () => {
                                          let newAnswer =
                                              lodash.cloneDeep(answer);
                                          newAnswer = updateAnswer(
                                              newAnswer,
                                              index,
                                              props.subtype
                                          );
