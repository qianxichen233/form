...
const getType = (type) => {
    ...
    if (type.type === "MultipleChoice") {
        if (type.subtype === "multichoice") return "MultipleChoice";
        if (type.subtype === "checkbox") return "Checkbox";
    }
    if (type.type === "TextAnswer") {
        if (type.subtype === "shortanswer") return "ShortAnswer";
        if (type.subtype === "paragraph") return "Paragraph";
    }
    if (type.type === "DateTimeInput") {
        if (type.subtype === "date") return "Date";
        if (type.subtype === "time") return "Time";
    }
};
